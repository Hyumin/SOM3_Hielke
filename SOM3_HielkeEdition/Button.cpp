...
void Button::SetTextureDrawModeWithSheet(const std::string& _texName, SDL_Rect _norm, SDL_Rect _clicked, SDL_Rect _hovered)
{
	RenderInterface n, c, h;
	n = { _norm,{0,0,0,0},_texName, SDL_RendererFlip::SDL_FLIP_NONE,{0,0} };
	c = n;
	h = n;
